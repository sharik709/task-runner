...
class ScheduleConfig(BaseModel):
    ...
    interval: Optional[str] = Field(None, description="Interval for recurring tasks (e.g., '1h', '1d')")
...
class TaskConfig(BaseModel):
    ...
    dependencies: List[str] = Field(default_factory=list, description="List of task names this task depends on")
